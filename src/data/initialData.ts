...
export const materials = [
  ...
  // === AW素材の拡充 ===
  {
    id: "suede-leather",
    name: "スウェードレザー",
    description: "革の内側を起毛させた、柔らかく温かみのある質感の素材。秋冬のラグジュアリーファッションの定番。",
    keywords: ["suede", "soft-leather", "napped-finish", "autumn-winter", "luxury", "textured", "matte"],
    season: ["autumn", "winter"],
    formality: ["casual", "business_casual", "luxury"],
    compatibility: ["wool-knit", "cashmere", "denim", "corduroy", "silk"],
    texture: "soft-napped",
    weight: "medium",
    care: ["professional-suede-cleaning", "waterproof-spray"],
    sustainability: "low",
    priceRange: "luxury"
  },
  {
    id: "shearling",
    name: "シアリング（ムートン）",
    description: "羊の毛皮を使用した素材。毛が内側に来るように使用され、極めて高い保温性と豪華な見た目を持つ。",
    keywords: ["shearling", "sheepskin", "mouton", "fur-lined", "ultra-warm", "luxury-winter", "cozy"],
    season: ["winter"],
    formality: ["casual_luxury", "outdoor_luxury"],
    compatibility: ["leather", "denim", "wool", "cashmere"],
    texture: "fluffy-soft",
    weight: "heavy",
    care: ["professional-fur-cleaning", "special-storage"],
    sustainability: "low",
    priceRange: "ultra-luxury"
  },
  {
    id: "real-fur",
    name: "リアルファー",
    description: "ミンク、フォックス、チンチラなどの本物の毛皮。最高級の保温性と贅沢感を持つが、倫理的議論もある素材。",
    keywords: ["real-fur", "mink", "fox-fur", "chinchilla", "sable", "luxury-fur", "controversial"],
    season: ["winter"],
    formality: ["formal_luxury", "evening", "special-occasion"],
    compatibility: ["silk", "velvet", "cashmere", "fine-wool"],
    texture: "ultra-soft-fluffy",
    weight: "medium-to-heavy",
    care: ["professional-fur-specialist", "cold-storage"],
    sustainability: "very-low",
    priceRange: "ultra-luxury"
  },
  {
    id: "nubuck-leather",
    name: "ヌバックレザー",
    description: "革の表面を軽く起毛させた素材。スウェードより目が細かく、ベルベットのような手触り。",
    keywords: ["nubuck", "buffed-leather", "velvet-touch", "fine-grain", "premium-leather"],
    season: ["spring", "autumn", "winter"],
    formality: ["casual", "smart_casual", "luxury"],
    compatibility: ["cotton", "linen", "silk", "wool"],
    texture: "velvet-like",
    weight: "medium",
    care: ["nubuck-specific-care", "protective-spray"],
    sustainability: "low",
    priceRange: "luxury"
  },
  {
...
export const silhouettes = [
  ...
  // デニムパンツのバリエーション
  {
    id: "skinny-jeans",
    name: "スキニージーンズ",
    description: "脚に密着するタイトなシルエットのデニムパンツ。2000年代後半から2010年代に大流行。",
    keywords: ["skinny-jeans", "tight-fit", "slim-denim", "body-hugging", "stretch-denim"],
    bodyTypes: ["slim", "athletic", "petite"],
    occasions: ["casual", "night-out", "modern-casual"],
    seasons: ["all"],
    eras: ["2000s", "2010s"],
    compatibility: ["oversized-tops", "boots", "heels", "sneakers"],
    formality: ["casual", "casual-chic"],
    ageGroups: ["teens", "20s", "30s"]
  },
  {
    id: "straight-jeans",
    name: "ストレートジーンズ",
    description: "太ももから裾まで同じ幅のクラシックなデニムパンツ。最も汎用性の高い定番シルエット。",
    keywords: ["straight-jeans", "classic-denim", "regular-fit", "timeless", "versatile"],
    bodyTypes: ["all"],
    occasions: ["everyday", "casual", "smart-casual"],
    seasons: ["all"],
    eras: ["timeless"],
    compatibility: ["all-tops", "any-footwear", "versatile-styling"],
  ...
  },
  {
    id: "bootcut-jeans",
    name: "ブーツカットジーンズ",
    description: "膝から裾にかけて緩やかに広がるシルエット。ブーツを履きやすいデザイン。",
    keywords: ["bootcut-jeans", "flared-hem", "boot-friendly", "slight-flare", "70s-inspired"],
    bodyTypes: ["all", "pear", "curvy"],
    occasions: ["casual", "western", "retro-style"],
    seasons: ["all"],
    eras: ["1970s", "1990s", "early-2000s"],
    compatibility: ["boots", "heels", "fitted-tops", "tucked-shirts"],
    formality: ["casual", "smart-casual"],
    ageGroups: ["20s", "30s", "40s", "50s+"]
  },
  {
    id: "boyfriend-jeans",
    name: "ボーイフレンドジーンズ",
    description: "男性物を借りたようなゆったりとしたシルエット。リラックス感のある着こなしが特徴。",
    keywords: ["boyfriend-jeans", "relaxed-fit", "borrowed-from-boys", "loose", "comfortable"],
    bodyTypes: ["all"],
    occasions: ["weekend", "casual", "relaxed"],
    seasons: ["all"],
    eras: ["2010s", "2020s"],
    compatibility: ["fitted-tops", "heels-for-contrast", "sneakers", "feminine-blouses"],
    formality: ["casual"],
    ageGroups: ["teens", "20s", "30s", "40s"]
  },
  {
    id: "mom-jeans",
    name: "マムジーンズ",
    description: "80年代〜90年代のお母さん世代が履いていたハイウエストでゆったりしたデニム。レトロな魅力。",
    keywords: ["mom-jeans", "high-waist", "vintage-denim", "80s-90s", "relaxed-tapered"],
    bodyTypes: ["all", "pear", "hourglass"],
    occasions: ["casual", "vintage-style", "weekend"],
    seasons: ["all"],
    eras: ["1980s", "1990s", "2020s-revival"],
    compatibility: ["crop-tops", "tucked-tees", "vintage-sneakers", "retro-accessories"],
    formality: ["casual"],
    ageGroups: ["teens", "20s", "30s"]
  },
  {
    id: "wide-leg-jeans",
    name: "ワイドレッグジーンズ",
    description: "全体的に幅広のシルエットを持つトレンドのデニムパンツ。快適性とスタイルを両立。",
    keywords: ["wide-leg-jeans", "baggy-denim", "loose-fit", "comfortable", "trendy"],
    bodyTypes: ["all"],
    occasions: ["casual", "streetwear", "creative"],
    seasons: ["all"],
    eras: ["1990s", "2020s"],
    compatibility: ["fitted-tops", "crop-tops", "oversized-blazers", "chunky-sneakers"],
    formality: ["casual", "streetwear"],
    ageGroups: ["teens", "20s", "30s"]
  },
  {
    id: "flare-jeans",
    name: "フレアジーンズ",
    description: "膝から大きく広がる70年代風のデニムパンツ。レトロでドラマチックなシルエット。",
    keywords: ["flare-jeans", "bell-bottoms", "70s-style", "dramatic-flare", "retro-denim"],
    bodyTypes: ["all", "petite-with-heels", "tall"],
    occasions: ["festival", "retro-party", "bohemian"],
    seasons: ["spring", "summer", "autumn"],
    eras: ["1970s", "2020s-revival"],
    compatibility: ["platform-shoes", "crop-tops", "bohemian-blouses", "retro-accessories"],
  ...
  },
  {
    id: "distressed-jeans",
    name: "ダメージジーンズ",
    description: "意図的に破れや擦れを加えたデニムパンツ。エッジの効いたカジュアルスタイル。",
    keywords: ["distressed-jeans", "ripped-denim", "destroyed", "edgy", "worn-look"],
    bodyTypes: ["all"],
    occasions: ["casual", "concerts", "streetwear", "edgy-events"],
    seasons: ["spring", "summer", "autumn"],
    eras: ["1990s", "2000s", "2010s", "2020s"],
    compatibility: ["band-tees", "leather-jackets", "sneakers", "boots"],
    formality: ["casual", "edgy-casual"],
    ageGroups: ["teens", "20s", "30s"]
  },
...
export const styleTrends = [
  ...
  },
  {
    id: "tech-minimalism",
    name: "テックミニマリズム",
    description: "シンプルなデザインに高機能素材を組み合わせた洗練されたテクノロジーファッション。",
    keywords: ["tech-minimal", "clean-tech", "smart-fabrics", "minimal-functional", "sleek"],
    era: "2020s",
    seasons: ["all"],
    occasions: ["urban", "business_tech", "smart_casual"],
    colors: ["monochrome", "black", "white", "grey", "navy"],
    materials: ["merino-tech", "smart-cotton", "performance-wool", "breathable-synthetics"],
    compatibility: ["minimal-sneakers", "sleek-backpack", "smart-watch", "wireless-earbuds"],
    popularity: 80,
    formality: ["smart_casual", "business_casual_tech"],
    mood: ["sophisticated", "minimal", "functional", "modern", "clean"]
  },
  ...
  // ロリータファッション
  {
    id: "sweet-lolita",
    name: "スウィートロリータ",
    description: "パステルカラー、リボン、レース、フリルをふんだんに使った最も甘く可愛らしいロリータスタイル。",
    keywords: ["sweet-lolita", "kawaii", "pastel", "frills", "ribbons", "lace", "doll-like"],
    era: "1990s-present",
    seasons: ["spring", "summer"],
    occasions: ["lolita-events", "tea-parties", "conventions", "special-occasions"],
    colors: ["baby-pink", "mint-green", "lavender", "sky-blue", "cream", "white"],
    materials: ["cotton-lace", "chiffon", "tulle", "satin-ribbon", "velvet-ribbon"],
    compatibility: ["petticoat", "mary-jane-shoes", "lace-gloves", "parasol", "hair-bow"],
    popularity: 65,
    formality: ["subculture", "special-event"],
    mood: ["cute", "innocent", "dreamy", "fantastical", "doll-like"]
  },
  {
    id: "gothic-lolita",
    name: "ゴシックロリータ",
    description: "黒を基調とし、ゴシック要素とロリータの可愛らしさを融合させたダークで優雅なスタイル。",
    keywords: ["gothic-lolita", "goth-loli", "dark-elegant", "victorian-goth", "black-lace"],
    era: "1990s-present",
    seasons: ["autumn", "winter"],
    occasions: ["gothic-events", "lolita-meetups", "concerts", "conventions"],
    colors: ["black", "burgundy", "deep-purple", "blood-red", "white-accent"],
    materials: ["black-velvet", "lace", "brocade", "satin", "leather-accents"],
    compatibility: ["platform-boots", "cross-accessories", "lace-parasol", "gothic-jewelry"],
    popularity: 60,
    formality: ["subculture", "alternative"],
    mood: ["dark", "elegant", "mysterious", "romantic", "dramatic"]
  },
  {
    id: "classic-lolita",
    name: "クラシックロリータ",
    description: "より成熟した印象のロリータスタイル。アンティーク調のデザインと落ち着いた色使いが特徴。",
    keywords: ["classic-lolita", "vintage-inspired", "mature-lolita", "antique-style", "elegant-lolita"],
    era: "1990s-present",
    seasons: ["all"],
    occasions: ["tea-ceremonies", "classical-concerts", "lolita-gatherings", "museums"],
    colors: ["wine-red", "navy", "forest-green", "camel", "ivory", "dusty-rose"],
    materials: ["gobelin", "jacquard", "velvet", "antique-lace", "silk"],
    compatibility: ["vintage-boots", "cameo-brooch", "antique-bag", "pearl-accessories"],
    popularity: 55,
    formality: ["subculture", "elegant-alternative"],
    mood: ["elegant", "vintage", "sophisticated", "nostalgic", "refined"]
  },
  ...
  // 古着系スタイル
  {
    ...
    name: "ヴィンテージアメリカーナ",
    description: "50年代から90年代のアメリカンカジュアルを現代的に解釈した古着スタイル。",
    keywords: ["vintage-americana", "retro-american", "thrifted", "classic-casual", "heritage"],
    era: "revival-of-1950s-1990s",
    seasons: ["all"],
    occasions: ["casual", "weekend", "vintage-shopping", "festivals"],
    colors: ["faded-blue", "vintage-wash", "sun-bleached", "earthy", "retro-prints"],
    materials: ["vintage-denim", "worn-leather", "distressed-cotton", "flannel"],
    compatibility: ["vintage-tees", "worn-boots", "trucker-jacket", "vintage-accessories"],
    popularity: 85,
    formality: ["casual", "vintage-casual"],
    mood: ["nostalgic", "authentic", "relaxed", "timeless", "cool"]
  },
  {
    id: "euro-vintage",
    name: "ヨーロピアンヴィンテージ",
    description: "ヨーロッパの古着を中心とした、洗練された雰囲気のヴィンテージスタイル。",
    keywords: ["euro-vintage", "european-thrift", "sophisticated-vintage", "continental-style"],
    era: "revival-of-1960s-1980s",
    seasons: ["all"],
    occasions: ["art-galleries", "cafes", "cultural-events", "vintage-markets"],
    colors: ["muted-tones", "earthy-neutrals", "vintage-patterns", "aged-colors"],
    materials: ["vintage-wool", "aged-leather", "linen", "vintage-silk"],
    compatibility: ["vintage-blazer", "leather-shoes", "vintage-scarf", "antique-jewelry"],
    popularity: 70,
    formality: ["smart_casual", "vintage-chic"],
    mood: ["sophisticated", "artistic", "nostalgic", "cultured", "unique"]
  },
  {
    id: "thrift-core",
    name: "スリフトコア",
    description: "古着屋での掘り出し物を組み合わせた、個性的でサステナブルなファッションスタイル。",
    keywords: ["thrift-core", "secondhand-chic", "sustainable-vintage", "eclectic-mix", "upcycled"],
    era: "2020s",
    seasons: ["all"],
    occasions: ["everyday", "creative-events", "sustainable-fashion", "casual-outings"],
    colors: ["mixed-periods", "eclectic-palette", "unexpected-combinations"],
    materials: ["mixed-vintage", "various-decades", "repurposed-materials"],
    compatibility: ["mix-match-eras", "diy-accessories", "personalized-items"],
    popularity: 90,
    formality: ["casual", "creative-casual"],
    mood: ["individualistic", "sustainable", "creative", "authentic", "experimental"]
  },
  {
    id: "solarpunk",
    name: "ソーラーパンク",
